...
public class PhotoController {
	 ...
	 * @return -
	 */
	@RequestMapping("${homeserver.api.path:}/photo/years")
	 ...
	 * @return -
	 */
	@RequestMapping("${homeserver.api.path:}/photo/years/{year}")
	 ...
	 */
	@RequestMapping("${homeserver.api.path:}/photo/years/{year}/THUMB")
	 ...
	 * @throws HomeServerException -
	 */
	@RequestMapping("${homeserver.api.path:}/photo/years/{year}/{month}/THUMB")
	 ...
	 * @throws HomeServerException -
	 */
	@RequestMapping("${homeserver.api.path:}/photo/years/{year}/{month}/{day}/THUMB")
	 ...
	 * @return -
	 */
	@RequestMapping("${homeserver.api.path:}/photo/years/{year}/{month}")
	 ...
	 * @return -
	 */
	@RequestMapping("${homeserver.api.path:}/photo/years/{year}/{month}/{day}")
	 ...
	 * @return -
	 */
	@RequestMapping("${homeserver.api.path:}/photo/years/{year}/{month}/{day}/{id}/")
	 ...
	 * @throws HomeServerException -
	 */
	@RequestMapping(value = "${homeserver.api.path:}/photo/years/{year}/{month}/{day}/{id}/{resolution}", produces = {MediaType.IMAGE_PNG_VALUE, MediaType.IMAGE_JPEG_VALUE})
	 ...
	 * @throws HomeServerException -
	 */
	@RequestMapping(path = "${homeserver.api.path:}/photo", method = {RequestMethod.POST})
