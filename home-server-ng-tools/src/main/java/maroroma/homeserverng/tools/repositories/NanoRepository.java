...
public class NanoRepository {
    ...
    private void saveToFile(final Object toSave) {
     ...
     * @return -
     */
    public <T> List<T> save(final T item) {
     ...
     * @throws HomeServerException -
     */
    private <T> void applyPreProcessor(final T item) {
            ...
            Arrays.stream(Consumer.class.getMethods())
                    ...
                    .ifPresent(m -> {
                        try {
                            ...
                            throw new RuntimeHomeServerException(e, "un erreur est survenue lors de l'application des preprocessor");
                        }
                    });
        }
    }
     ...
     * @return -
     */
    public <T> T saveAndReturn(final T item) {
        Assert.notNull(item, "item can't be null");
     ...
     * @return -
     */
    public <T> List<T> findAll(final Predicate<T> predicate) {
        Assert.notNull(predicate, "predicate can't be null");
     ...
     * @return -
     */
    public <T> List<T> update(final T item) {
        Assert.notNull(item, "item can't be null");
     ...
     * @return -
     */
    public <T> List<T> update(final T item, final Predicate<T> predicate) {
        Assert.notNull(item, "item can't be null");
        Assert.notNull(predicate, "predicate can't be null");
     ...
     * @return -
     */
    public <T> List<T> delete(final Object id) {
        Assert.notNull(id, "id can't be null");
     ...
     * @return -
     */
    public <T> List<T> delete(final Predicate<T> predicate) {
        Assert.notNull(predicate, "predicate can't be null");
